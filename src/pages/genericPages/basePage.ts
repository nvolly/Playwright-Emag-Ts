...
export default class BasePage {
  ...
  constructor(page: Page) {
    ...
    this.inputUserLogareSesiuneExpirata = page.locator('input.login-form-field.usernamelogin');
    this.inputParolaLogareSesiuneExpirata = page.locator('input.login-form-field.parolalogin');
